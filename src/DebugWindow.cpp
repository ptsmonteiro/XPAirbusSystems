	...
	void *               inRefcon)
{
	...
	* rectangle that is our window's shape. */
	...
	appendLine(formatString("ELAC1 Roll: rate/stick deflection			= ", Aircraft->elac1->rollRateConstant));
	appendLine(formatString("ELAC1 Pitch: Load factor/stick deflection	= ", Aircraft->elac1->pitchLoadFactorConstant));
}
